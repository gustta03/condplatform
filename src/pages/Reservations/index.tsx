...
// export interface TypeReservations {
//   id: number;
//   id_area: number;
//   name_area: string;
//   name_unit: string;
...
//   const { currentItems, currentPage, setCurrentPage } = useCurrentPage(dataReservation, PageSize)
...
//       .then(res => {
//         if (res.data.error === '') {
//           toasts.sucessNotification(
//             'Reserva Excluída com sucesso com sucesso'
//           );
//         }
//       })
...
import { toasts } from '../../utils/toast';
import { Pagination } from '../../components/Pagenation';
import { useCurrentPage, usePagination } from '../../hooks/usePagination';
